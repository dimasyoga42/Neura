...
export const messageEn = {
  ...
  noCommand:
    "Command not found. Please check the available commands and try again.",
  missingArgs:
    "Missing arguments. Please check the command usage and try again.",
  invalidArgs:
    "Invalid arguments. Please check the command usage and try again.",
  success: "Command executed successfully!",
  null: "No data found for your request.",
  notfound: "The requested resource was not found.",
  xtalnotfound:
    "Xtal not found. Please check the available xtals and try again.",
  regisnotfound:
    "Regis not found. Please check the available regis and try again.",
  abilitynotfound:
    "Ability not found. Please check the available abilities and try again.",
  itemnotfound:
    "Item not found. Please check the available items and try again.",
  bosnotfound:
    "Boss not found. Please check the available bosses and try again.",
  monsternotfound:
    "Monster not found. Please check the available monsters and try again.",
};
